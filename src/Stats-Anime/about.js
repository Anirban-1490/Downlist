    ...
    return <>
       ...
       <div className="banner"><img src={logo} alt="" /></div>
        <p className="main-details">Uplist is a <b>Personal Project</b> of mine which is a place for <b>Anime Lovers</b>.
         ...
         <h3>This Project is made using Jikan API - <a href="https://github.com/jikan-me/jikan" target={"_blank"} rel="noreferrer">More details</a></h3>
         <h3>More information on <i>Uplist</i> - <a href="https://github.com/Anirban-1490/Project-Uplist" target={"_blank"} rel="noreferrer">Github Page</a></h3>

         <h3 className="connect">Connect with me</h3>
         <ul className="social">
            <a href="https://www.linkedin.com/in/anirban-pratihar-48a591226/" target={"_blank"} rel="noreferrer">

                <i class="fab fa-linkedin"></i>
            </a>

            <a href="https://github.com/Anirban-1490" target={"_blank"} rel="noreferrer">

                <i class="fab fa-github"></i>
            </a>
            <a href="https://twitter.com/Anirban45555" target={"_blank"} rel="noreferrer">
