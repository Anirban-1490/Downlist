...
export async function getStaticProps() {
    ...
    try {
         ...
         *? errors can be handled on the server.
         */

        //* use too get the top 20 upcoming anime from a Jikan endpoint
        ...
        //* use too get the top 20 airing anime from a Jikan endpoint
        ...
        //* use too get the top 20 popular anime from a Jikan endpoint
